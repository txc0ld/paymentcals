...
export function RuleUnavailableState({
  ...
  return (
    <div role="status" className="nexus-panel grid gap-4 p-8 text-center">
    ...
    <div role="alert" className="nexus-panel grid gap-4 border-error bg-error-surface p-8 text-center">
      ...
      {onExportInputs ? (
        <button
          ...
          className="nexus-quiet-button mx-auto min-h-11 px-4 py-2 font-mono text-[11px] uppercase tracking-[0.14em] text-ink hover:bg-surface-2 focus-visible:outline-3 focus-visible:outline-offset-3 focus-visible:outline-focus"
        >
...
export function EmptyState({ children }: { children: ReactNode }) {
  return (
    <div className="nexus-panel-soft grid min-h-48 place-items-center gap-2 border-dashed border-hairline-strong p-8 text-center md:p-10">
