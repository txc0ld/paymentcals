...
export function PrimaryResult({
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <span aria-hidden="true" className="font-mono text-[length:var(--pc-text-result-xl)] font-medium leading-none tracking-tight tabular-nums text-ink">
        {swept}
      </span>
...
export function ResultMetric({
  ...
  return (
    <div className="flex flex-col gap-1 border border-hairline bg-surface p-4">
